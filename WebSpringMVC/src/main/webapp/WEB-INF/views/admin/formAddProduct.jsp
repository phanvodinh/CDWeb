        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <form class="row" action="<c:url value="/admin/addProduct"/>" method="post"
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" name="nameProduct" type="text"/>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="id_category" id="exampleSelect1">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="detail" id="mota"></textarea>
                            <script>CKEDITOR.replace('mota');</script>
                        </div>
                        <button class="btn btn-save" type="submit">Lưu lại</button>
                        <a class="btn btn-cancel" href="<c:url value="admin/addPro"/>">Hủy bỏ</a>
                    </form>
                </div>
