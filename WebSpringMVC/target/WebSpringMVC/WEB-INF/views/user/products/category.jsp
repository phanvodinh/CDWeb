...
<div class="well well-small">
            ...
            <li class="span4">
                <div class="thumbnail">
                    <a href="product_details.html" class="overlay"></a> <a
                        class="zoomTool" href="<c:url value="/chi-tiet/${item.id_product}"/>" title="add to cart"><span
                        class="icon-search"></span> QUICK VIEW</a> <a
                        href="<c:url value="/chi-tiet/${item.id_product}"/>"><img
    ...
    <c:if test="${(loop.index+1)%3 < productsPaginate.size()}">
    <div class="row-fluid">
        <ul class="thumbnails">
